...
import com.baeldung.lsol.persistence.repository.impl.InMemoryCampaignRepository;
import com.baeldung.lsol.persistence.repository.impl.InMemoryTaskRepository;
import com.baeldung.lsol.persistence.repository.impl.InMemoryWorkerRepository;
...
import com.baeldung.lsol.service.impl.DefaultCampaignService;
import com.baeldung.lsol.service.impl.DefaultReportsService;
import com.baeldung.lsol.service.impl.DefaultTaskService;
import com.baeldung.lsol.service.impl.DefaultWorkerService;
import com.baeldung.lsol.service.reports.DetailedMapReportBuilder;
import com.baeldung.lsol.service.reports.SimpleMapReportBuilder;
...
public class LsolApp {
    ...
    public static void main(String[] args) {
        ...
        CampaignService campaignService = new DefaultCampaignService(new InMemoryCampaignRepository());
        TaskService taskService = new DefaultTaskService(new InMemoryTaskRepository());
        WorkerService workerService = new DefaultWorkerService(new InMemoryWorkerRepository());
