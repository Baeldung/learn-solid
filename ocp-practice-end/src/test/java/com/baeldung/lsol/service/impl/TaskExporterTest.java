...
class TaskExporterTest {
    ...
    void whenExportTasksAsCSV_thenReturnsCorrectFormat() {
        TaskExporter exporter = new CsvTaskExporter();

        String csv = exporter.export(dummyTasks);
    ...
    void whenExportTasksAsJSON_thenReturnsCorrectFormat() {
        TaskExporter exporter = new JsonTaskExporter();

        String json = exporter.export(dummyTasks);
